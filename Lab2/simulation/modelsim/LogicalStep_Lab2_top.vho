...
SIGNAL \INST7|logic_out[0]~0_combout\ : std_logic;
SIGNAL \sw[1]~input_o\ : std_logic;
SIGNAL \sw[5]~input_o\ : std_logic;
SIGNAL \INST0|INST2|Carry_Out~0_combout\ : std_logic;
SIGNAL \sw[6]~input_o\ : std_logic;
SIGNAL \sw[2]~input_o\ : std_logic;
SIGNAL \INST7|logic_out[2]~2_combout\ : std_logic;
SIGNAL \sw[7]~input_o\ : std_logic;
SIGNAL \sw[3]~input_o\ : std_logic;
SIGNAL \INST0|INST3|Carry_Out~0_combout\ : std_logic;
SIGNAL \INST7|logic_out[3]~3_combout\ : std_logic;
SIGNAL \INST0|INST2|Sum~combout\ : std_logic;
SIGNAL \INST7|logic_out[1]~1_combout\ : std_logic;
SIGNAL \INST1|Mux5~0_combout\ : std_logic;
SIGNAL \INST6|logic_out[2]~3_combout\ : std_logic;
SIGNAL \INST6|logic_out[3]~4_combout\ : std_logic;
SIGNAL \INST6|logic_out[0]~0_combout\ : std_logic;
SIGNAL \INST6|logic_out[0]~1_combout\ : std_logic;
SIGNAL \INST6|logic_out[1]~2_combout\ : std_logic;
...
\INST7|logic_out[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST7|logic_out[0]~0_combout\ = \sw[0]~input_o\ $ (((\sw[4]~input_o\ & !\pb_n[2]~input_o\)))
...
PORT MAP (
	...
	combout => \INST7|logic_out[0]~0_combout\);
...
\INST0|INST2|Carry_Out~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST0|INST2|Carry_Out~0_combout\ = (\sw[1]~input_o\ & ((\sw[5]~input_o\) # ((\sw[0]~input_o\ & \sw[4]~input_o\)))) # (!\sw[1]~input_o\ & (\sw[0]~input_o\ & (\sw[4]~input_o\ & \sw[5]~input_o\)))
...
PORT MAP (
	...
	datac => \sw[4]~input_o\,
	datad => \sw[5]~input_o\,
	combout => \INST0|INST2|Carry_Out~0_combout\);
...
\INST7|logic_out[2]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST7|logic_out[2]~2_combout\ = \sw[2]~input_o\ $ (((!\pb_n[2]~input_o\ & (\INST0|INST2|Carry_Out~0_combout\ $ (\sw[6]~input_o\)))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST0|INST2|Carry_Out~0_combout\,
	datab => \pb_n[2]~input_o\,
	datac => \sw[6]~input_o\,
	datad => \sw[2]~input_o\,
	combout => \INST7|logic_out[2]~2_combout\);
...
\INST0|INST3|Carry_Out~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST0|INST3|Carry_Out~0_combout\ = (\INST0|INST2|Carry_Out~0_combout\ & ((\sw[6]~input_o\) # (\sw[2]~input_o\))) # (!\INST0|INST2|Carry_Out~0_combout\ & (\sw[6]~input_o\ & \sw[2]~input_o\))
...
PORT MAP (
	...
	datac => \sw[6]~input_o\,
	datad => \sw[2]~input_o\,
	combout => \INST0|INST3|Carry_Out~0_combout\);

-- Location: LCCOMB_X9_Y7_N0
\INST7|logic_out[3]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST7|logic_out[3]~3_combout\ = \sw[3]~input_o\ $ (((!\pb_n[2]~input_o\ & (\sw[7]~input_o\ $ (\INST0|INST3|Carry_Out~0_combout\)))))
...
PORT MAP (
	...
	datab => \pb_n[2]~input_o\,
	datac => \sw[3]~input_o\,
	datad => \INST0|INST3|Carry_Out~0_combout\,
	combout => \INST7|logic_out[3]~3_combout\);

-- Location: LCCOMB_X9_Y7_N22
\INST0|INST2|Sum\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST0|INST2|Sum~combout\ = \sw[1]~input_o\ $ (\sw[5]~input_o\ $ (((\sw[0]~input_o\ & \sw[4]~input_o\))))
...
PORT MAP (
	...
	datac => \sw[4]~input_o\,
	datad => \sw[5]~input_o\,
	combout => \INST0|INST2|Sum~combout\);

-- Location: LCCOMB_X9_Y7_N28
\INST7|logic_out[1]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST7|logic_out[1]~1_combout\ = (\pb_n[2]~input_o\ & ((\sw[1]~input_o\))) # (!\pb_n[2]~input_o\ & (\INST0|INST2|Sum~combout\))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST0|INST2|Sum~combout\,
	datab => \pb_n[2]~input_o\,
	datac => \sw[1]~input_o\,
	combout => \INST7|logic_out[1]~1_combout\);

-- Location: LCCOMB_X11_Y7_N2
\INST1|Mux5~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST1|Mux5~0_combout\ = (\INST7|logic_out[3]~3_combout\ & ((\INST7|logic_out[0]~0_combout\ & ((\INST7|logic_out[1]~1_combout\))) # (!\INST7|logic_out[0]~0_combout\ & (\INST7|logic_out[2]~2_combout\)))) # (!\INST7|logic_out[3]~3_combout\ & 
-- (\INST7|logic_out[2]~2_combout\ & (\INST7|logic_out[0]~0_combout\ $ (\INST7|logic_out[1]~1_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST7|logic_out[0]~0_combout\,
	datab => \INST7|logic_out[2]~2_combout\,
	datac => \INST7|logic_out[3]~3_combout\,
	datad => \INST7|logic_out[1]~1_combout\,
	combout => \INST1|Mux5~0_combout\);

-- Location: LCCOMB_X9_Y7_N8
\INST6|logic_out[2]~3\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST6|logic_out[2]~3_combout\ = (\sw[6]~input_o\ & \pb_n[2]~input_o\)
...
PORT MAP (
	datac => \sw[6]~input_o\,
	datad => \pb_n[2]~input_o\,
	combout => \INST6|logic_out[2]~3_combout\);

-- Location: LCCOMB_X9_Y7_N6
\INST6|logic_out[3]~4\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST6|logic_out[3]~4_combout\ = (\sw[7]~input_o\ & \pb_n[2]~input_o\)
...
PORT MAP (
	datac => \sw[7]~input_o\,
	datad => \pb_n[2]~input_o\,
	combout => \INST6|logic_out[3]~4_combout\);

-- Location: LCCOMB_X9_Y7_N2
\INST6|logic_out[0]~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST6|logic_out[0]~0_combout\ = (\sw[7]~input_o\ & ((\sw[3]~input_o\) # (\INST0|INST3|Carry_Out~0_combout\))) # (!\sw[7]~input_o\ & (\sw[3]~input_o\ & \INST0|INST3|Carry_Out~0_combout\))
...
PORT MAP (
	...
	datac => \sw[3]~input_o\,
	datad => \INST0|INST3|Carry_Out~0_combout\,
	combout => \INST6|logic_out[0]~0_combout\);

-- Location: LCCOMB_X9_Y7_N16
\INST6|logic_out[0]~1\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST6|logic_out[0]~1_combout\ = (\pb_n[2]~input_o\ & (\sw[4]~input_o\)) # (!\pb_n[2]~input_o\ & ((\INST6|logic_out[0]~0_combout\)))
...
PORT MAP (
	datab => \pb_n[2]~input_o\,
	datac => \sw[4]~input_o\,
	datad => \INST6|logic_out[0]~0_combout\,
	combout => \INST6|logic_out[0]~1_combout\);

-- Location: LCCOMB_X9_Y7_N14
\INST6|logic_out[1]~2\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST6|logic_out[1]~2_combout\ = (\pb_n[2]~input_o\ & \sw[5]~input_o\)
...
PORT MAP (
	datab => \pb_n[2]~input_o\,
	datad => \sw[5]~input_o\,
	combout => \INST6|logic_out[1]~2_combout\);

-- Location: LCCOMB_X10_Y7_N4
\INST2|Mux5~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST2|Mux5~0_combout\ = (\INST6|logic_out[3]~4_combout\ & ((\INST6|logic_out[0]~1_combout\ & ((\INST6|logic_out[1]~2_combout\))) # (!\INST6|logic_out[0]~1_combout\ & (\INST6|logic_out[2]~3_combout\)))) # (!\INST6|logic_out[3]~4_combout\ & 
-- (\INST6|logic_out[2]~3_combout\ & (\INST6|logic_out[0]~1_combout\ $ (\INST6|logic_out[1]~2_combout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \INST6|logic_out[2]~3_combout\,
	datab => \INST6|logic_out[3]~4_combout\,
	datac => \INST6|logic_out[0]~1_combout\,
	datad => \INST6|logic_out[1]~2_combout\,
...
-- Equation(s):
-- \INST1|Mux1~0_combout\ = (\INST7|logic_out[2]~2_combout\ & ((\INST7|logic_out[1]~1_combout\ & (\INST7|logic_out[0]~0_combout\ & !\INST7|logic_out[3]~3_combout\)) # (!\INST7|logic_out[1]~1_combout\ & ((\INST7|logic_out[3]~3_combout\))))) # 
-- (!\INST7|logic_out[2]~2_combout\ & (!\INST7|logic_out[3]~3_combout\ & ((\INST7|logic_out[0]~0_combout\) # (\INST7|logic_out[1]~1_combout\))))
...
PORT MAP (
	dataa => \INST7|logic_out[0]~0_combout\,
	datab => \INST7|logic_out[2]~2_combout\,
	datac => \INST7|logic_out[1]~1_combout\,
	datad => \INST7|logic_out[3]~3_combout\,
	combout => \INST1|Mux1~0_combout\);

-- Location: LCCOMB_X10_Y7_N30
\INST2|Mux1~0\ : fiftyfivenm_lcell_comb
-- Equation(s):
-- \INST2|Mux1~0_combout\ = (\INST6|logic_out[2]~3_combout\ & ((\INST6|logic_out[3]~4_combout\ & ((!\INST6|logic_out[1]~2_combout\))) # (!\INST6|logic_out[3]~4_combout\ & (\INST6|logic_out[0]~1_combout\ & \INST6|logic_out[1]~2_combout\)))) # 
-- (!\INST6|logic_out[2]~3_combout\ & (!\INST6|logic_out[3]~4_combout\ & ((\INST6|logic_out[0]~1_combout\) # (\INST6|logic_out[1]~2_combout\))))
...
-- Equation(s):
-- \INST1|Mux0~0_combout\ = (\INST7|logic_out[3]~3_combout\) # ((\INST7|logic_out[2]~2_combout\ & ((!\INST7|logic_out[1]~1_combout\) # (!\INST7|logic_out[0]~0_combout\))) # (!\INST7|logic_out[2]~2_combout\ & ((\INST7|logic_out[1]~1_combout\))))
...
-- Equation(s):
-- \INST2|Mux0~0_combout\ = (\INST6|logic_out[3]~4_combout\) # ((\INST6|logic_out[2]~3_combout\ & ((!\INST6|logic_out[1]~2_combout\) # (!\INST6|logic_out[0]~1_combout\))) # (!\INST6|logic_out[2]~3_combout\ & ((\INST6|logic_out[1]~2_combout\))))
...
-- Equation(s):
-- \INST1|Mux6~0_combout\ = (\INST7|logic_out[2]~2_combout\ & (!\INST7|logic_out[1]~1_combout\ & ((\INST7|logic_out[3]~3_combout\) # (!\INST7|logic_out[0]~0_combout\)))) # (!\INST7|logic_out[2]~2_combout\ & (\INST7|logic_out[0]~0_combout\ & 
-- (\INST7|logic_out[1]~1_combout\ $ (!\INST7|logic_out[3]~3_combout\))))
...
-- Equation(s):
-- \INST2|Mux6~0_combout\ = (\INST6|logic_out[2]~3_combout\ & (!\INST6|logic_out[1]~2_combout\ & ((\INST6|logic_out[3]~4_combout\) # (!\INST6|logic_out[0]~1_combout\)))) # (!\INST6|logic_out[2]~3_combout\ & (\INST6|logic_out[0]~1_combout\ & 
-- (\INST6|logic_out[3]~4_combout\ $ (!\INST6|logic_out[1]~2_combout\))))
...
-- Equation(s):
-- \INST1|Mux4~0_combout\ = (\INST7|logic_out[2]~2_combout\ & (\INST7|logic_out[3]~3_combout\ & ((\INST7|logic_out[1]~1_combout\) # (!\INST7|logic_out[0]~0_combout\)))) # (!\INST7|logic_out[2]~2_combout\ & (!\INST7|logic_out[0]~0_combout\ & 
-- (\INST7|logic_out[1]~1_combout\ & !\INST7|logic_out[3]~3_combout\)))
...
-- Equation(s):
-- \INST2|Mux4~0_combout\ = (\INST6|logic_out[2]~3_combout\ & (\INST6|logic_out[3]~4_combout\ & ((\INST6|logic_out[1]~2_combout\) # (!\INST6|logic_out[0]~1_combout\)))) # (!\INST6|logic_out[2]~3_combout\ & (!\INST6|logic_out[3]~4_combout\ & 
-- (!\INST6|logic_out[0]~1_combout\ & \INST6|logic_out[1]~2_combout\)))
...
-- Equation(s):
-- \INST2|Mux3~0_combout\ = (\INST6|logic_out[1]~2_combout\ & ((\INST6|logic_out[2]~3_combout\ & ((\INST6|logic_out[0]~1_combout\))) # (!\INST6|logic_out[2]~3_combout\ & (\INST6|logic_out[3]~4_combout\ & !\INST6|logic_out[0]~1_combout\)))) # 
-- (!\INST6|logic_out[1]~2_combout\ & (!\INST6|logic_out[3]~4_combout\ & (\INST6|logic_out[2]~3_combout\ $ (\INST6|logic_out[0]~1_combout\))))
...
-- Equation(s):
-- \INST1|Mux3~0_combout\ = (\INST7|logic_out[1]~1_combout\ & ((\INST7|logic_out[0]~0_combout\ & (\INST7|logic_out[2]~2_combout\)) # (!\INST7|logic_out[0]~0_combout\ & (!\INST7|logic_out[2]~2_combout\ & \INST7|logic_out[3]~3_combout\)))) # 
-- (!\INST7|logic_out[1]~1_combout\ & (!\INST7|logic_out[3]~3_combout\ & (\INST7|logic_out[0]~0_combout\ $ (\INST7|logic_out[2]~2_combout\))))
...
-- Equation(s):
-- \INST2|Mux2~0_combout\ = (\INST6|logic_out[1]~2_combout\ & (((!\INST6|logic_out[3]~4_combout\ & \INST6|logic_out[0]~1_combout\)))) # (!\INST6|logic_out[1]~2_combout\ & ((\INST6|logic_out[2]~3_combout\ & (!\INST6|logic_out[3]~4_combout\)) # 
-- (!\INST6|logic_out[2]~3_combout\ & ((\INST6|logic_out[0]~1_combout\)))))
...
-- Equation(s):
-- \INST1|Mux2~0_combout\ = (\INST7|logic_out[1]~1_combout\ & (\INST7|logic_out[0]~0_combout\ & ((!\INST7|logic_out[3]~3_combout\)))) # (!\INST7|logic_out[1]~1_combout\ & ((\INST7|logic_out[2]~2_combout\ & ((!\INST7|logic_out[3]~3_combout\))) # 
-- (!\INST7|logic_out[2]~2_combout\ & (\INST7|logic_out[0]~0_combout\))))
